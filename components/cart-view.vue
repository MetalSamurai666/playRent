            ...
            <div class="cart-view__box">
                ...
                <div class="cart-view__left">
                    ...
                    <div class="cart-view__body">
                        <div class="cart-view__empty" v-if="isObjectEmpty(cart)">
                        ...
                        <div class="cart-view__empt" v-else>
                            ...
                            <div class="cart-view__final">
                                <button class="cart-view__final__clear" @click="deleteAll">Очистить корзину</button>
